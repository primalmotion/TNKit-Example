@STATIC;1.0;p;9;TNAlert.jt;4944;@STATIC;1.0;t;4925;{var the_class = objj_allocateClassPair(CPObject, "TNAlert"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_alert"), new objj_ivar("_actions"), new objj_ivar("_target"), new objj_ivar("_userInfo")]);
objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("alert"), function $TNAlert__alert(self, _cmd)
{ with(self)
{
return _alert;
}
...
new objj_method(sel_getUid("actions"), function $TNAlert__actions(self, _cmd)
{ with(self)
{
return _actions;
}
},["id"]),
new objj_method(sel_getUid("_setActions:"), function $TNAlert___setActions_(self, _cmd, newValue)
{ with(self)
{
_actions = newValue;
}
},["void","id"]),
new objj_method(sel_getUid("target"), function $TNAlert__target(self, _cmd)
{ with(self)
{
return _target;
}
},["id"]),
new objj_method(sel_getUid("setTarget:"), function $TNAlert__setTarget_(self, _cmd, newValue)
{ with(self)
{
_target = newValue;
}
...
},["void","id"]), new objj_method(sel_getUid("initWithTitle:message:target:actions:"), function $TNAlert__initWithTitle_message_target_actions_(self, _cmd, aTitle, aMessage, aTarget, someActions)
{ with(self)
{
...
},["TNAlert","CPString","CPString","id","CPArray"]), new objj_method(sel_getUid("initWithTitle:message:informativeMessage:target:actions:"), function $TNAlert__initWithTitle_message_informativeMessage_target_actions_(self, _cmd, aTitle, aMessage, anInfo, aTarget, someActions)
{ with(self)
{
    if (self = objj_msgSend(self, "initWithTitle:message:target:actions:", aTitle, aMessage, aTarget, someActions))
    {
...
{ with(self)
{
    ...
    if (objj_msgSend(_target, "respondsToSelector:", selector))
        objj_msgSend(_target, "performSelector:withObject:", selector, _userInfo);
}
},["void","CPAlert","int"])]);
class_addMethods(meta_class, [new objj_method(sel_getUid("showAlertWithTitle:message:"), function $TNAlert__showAlertWithTitle_message_(self, _cmd, aTitle, aMessage)
{ with(self)
{
    var tnalert = objj_msgSend(objj_msgSend(TNAlert, "alloc"), "initWithTitle:message:target:actions:", aTitle, aMessage, nil, [["Ok", nil]]);
    objj_msgSend(tnalert, "runModal");
}
},["void","CPString","CPString"]), new objj_method(sel_getUid("alertWithTitle:message:target:actions:"), function $TNAlert__alertWithTitle_message_target_actions_(self, _cmd, aTitle, aMessage, aTarget, someActions)
{ with(self)
{
    var tnalert = objj_msgSend(objj_msgSend(TNAlert, "alloc"), "initWithTitle:message:target:actions:", aTitle, aMessage, aTarget, someActions);
    return tnalert;
}
},["void","CPString","CPString","id","CPArray"]), new objj_method(sel_getUid("alertWithTitle:message:informativeMessage:target:actions:"), function $TNAlert__alertWithTitle_message_informativeMessage_target_actions_(self, _cmd, aTitle, aMessage, anInfo, aTarget, someActions)
{ with(self)
{
    var tnalert = objj_msgSend(objj_msgSend(TNAlert, "alloc"), "initWithTitle:message:informativeMessage:target:actions:", aTitle, aMessage, anInfo, aTarget, someActions);
    return tnalert;
}
...
p;7;TNKit.jt;488;@STATIC;1.0;i;20;TNTextFieldStepper.ji;13;TNAnimation.ji;25;TNOutlineViewDataSource.ji;23;TNTableViewDataSource.ji;16;TNUserDefaults.ji;9;TNAlert.ji;17;TNQuickEditView.jt;313;objj_executeFile("TNTextFieldStepper.j", YES);
...
objj_executeFile("TNQuickEditView.j", YES);

p;25;TNOutlineViewDataSource.jt;6890;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;6823;objj_executeFile("Foundation/Foundation.j", NO);
...
p;17;TNQuickEditView.jt;6982;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;6915;objj_executeFile("Foundation/Foundation.j", NO);
objj_executeFile("AppKit/AppKit.j", NO);
TNQuickEditViewPadding = 20.0;
{var the_class = objj_allocateClassPair(CPView, "TNQuickEditView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_cursorView"), new objj_ivar("_closeButton"), new objj_ivar("_targetView"), new objj_ivar("_delegate")]);
objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("targetView"), function $TNQuickEditView__targetView(self, _cmd)
{ with(self)
{
return _targetView;
}
},["id"]),
new objj_method(sel_getUid("setTargetView:"), function $TNQuickEditView__setTargetView_(self, _cmd, newValue)
{ with(self)
{
_targetView = newValue;
}
},["void","id"]),
new objj_method(sel_getUid("delegate"), function $TNQuickEditView__delegate(self, _cmd)
{ with(self)
{
return _delegate;
}
},["id"]),
new objj_method(sel_getUid("setDelegate:"), function $TNQuickEditView__setDelegate_(self, _cmd, newValue)
{ with(self)
{
_delegate = newValue;
}
},["void","id"]), new objj_method(sel_getUid("initWithFrame:"), function $TNQuickEditView__initWithFrame_(self, _cmd, aFrame)
{ with(self)
{
    if (self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("TNQuickEditView").super_class }, "initWithFrame:", aFrame))
    {
        var bundle = objj_msgSend(CPBundle, "bundleForClass:", objj_msgSend(self, "class")),
            backgroundImage = objj_msgSend(objj_msgSend(CPNinePartImage, "alloc"), "initWithImageSlices:", [
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-top-left.png"), CPSizeMake(24.0, 16.0)),
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-top.png"), CPSizeMake(3.0, 16.0)),
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-top-right.png"), CPSizeMake(16.0, 16.0)),
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-left.png"), CPSizeMake(24.0, 3.0)),
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-center.png"), CPSizeMake(1.0, 16.0)),
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-right.png"), CPSizeMake(16.0, 3.0)),
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-bottom-left.png"), CPSizeMake(24.0, 16.0)),
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-bottom.png"), CPSizeMake(3.0, 16.0)),
                objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-bottom-right.png"), CPSizeMake(16.0, 16.0))
            ]),
            cursorBackground = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-arrow-left.png"), CPSizeMake(24.0, 40.0)),
            buttonClose = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-button-close.png"), CPSizeMake(15.0, 15.0)),
            buttonClosePressed = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "quick-edit-view/quick-edit-view-button-close-pressed.png"), CPSizeMake(15.0, 15.0));
        _closeButton = objj_msgSend(objj_msgSend(CPButton, "alloc"), "initWithFrame:", CPRectMake(aFrame.size.width - 14.0 - 12.0, 10.5, 14, 15));
        ...
        objj_msgSend(_closeButton, "setValue:forThemeAttribute:", buttonClose, "image");
        objj_msgSend(_closeButton, "setValue:forThemeAttribute:inState:", buttonClosePressed, "image", CPThemeStateHighlighted);
        ...
        _cursorView = objj_msgSend(objj_msgSend(CPView, "alloc"), "initWithFrame:", CPRectMake(0.0, CPRectGetHeight(aFrame) / 2.0 - 12.0, 24.0, 24.0));
        objj_msgSend(_cursorView, "setBackgroundColor:", objj_msgSend(CPColor, "colorWithPatternImage:", cursorBackground));
        objj_msgSend(self, "setBackgroundColor:", objj_msgSend(CPColor, "colorWithPatternImage:", backgroundImage));
        objj_msgSend(self, "addSubview:", _cursorView);
    }
    return self;
}
},["id","CGRect"]), new objj_method(sel_getUid("positionRelativeToView:"), function $TNQuickEditView__positionRelativeToView_(self, _cmd, aView)
{ with(self)
{
    var frameView = objj_msgSend(aView, "frame"),
        posX = frameView.origin.x + CPRectGetWidth(frameView),
        posY = frameView.origin.y + (CPRectGetHeight(frameView) / 2.0) - (CPRectGetHeight(objj_msgSend(self, "frame")) / 2.0),
        point = CPPointMake(posX, posY);
    objj_msgSend(self, "setFrameOrigin:", point);
    objj_msgSend(objj_msgSend(aView, "superview"), "addSubview:", self);
}
},["void","CPView"]), new objj_method(sel_getUid("attachToView:"), function $TNQuickEditView__attachToView_(self, _cmd, aView)
{ with(self)
{
    _targetView = aView;
    objj_msgSend(self, "positionRelativeToView:", _targetView);
}
},["void","CPView"]), new objj_method(sel_getUid("close:"), function $TNQuickEditView__close_(self, _cmd, aSender)
{ with(self)
{
    ...
    if (_delegate && objj_msgSend(_delegate, "respondsToSelected:", sel_getUid("didQuickEditViewClose:")))
        objj_msgSend(_delegate, "didQuickEditViewClose:", self);
}
},["IBAction","id"])]);
class_addMethods(meta_class, [new objj_method(sel_getUid("quickEditViewWithSize:forView:"), function $TNQuickEditView__quickEditViewWithSize_forView_(self, _cmd, aSize, aView)
{ with(self)
{
    var quickEdit = objj_msgSend(objj_msgSend(TNQuickEditView, "alloc"), "initWithFrame:", CPRectMake(0.0, 0.0, aSize.width, aSize.height));
    objj_msgSend(quickEdit, "attachToView:", aView);
    return quickEdit;
}
},["id","CGSize","CPView"])]);
}

p;23;TNTableViewDataSource.jt;8948;@STATIC;1.0;t;8929;{var the_class = objj_allocateClassPair(CPObject, "TNTableViewDataSource"),
